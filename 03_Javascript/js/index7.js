...
// map
//배열 내의 모든 요소에 대해 함수 호출한 결과를 모아서 새로운 배열로 변환

let arr4=[1,2,3,4,5]
let sum=arr4.map((number)=> number*3)
console.log(sum)

//find
//배열에서 특정 조건을 만족하는 첫번째 요소를 반환 

sum=arr4.find((number)=>number>3)
console.log(sum)
