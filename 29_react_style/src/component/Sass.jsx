...
{/* .container>.box1*3+p.circle*3+.box2{hi$}*4 */}
         ...
         <h5>상대 경로로 불러오기</h5>
         <img src="../assets/main.png" alt="src 내부에 이미지가 있을 때는 경로명으로 접근할 수 없습니다." />
         ...
         <h5>이미지 태그 사용하기</h5>
         <img src="/assets/main.png" alt="경로명으로 접근가능, public 폴더는 static 폴더이기 때문에 / 로 접근" />
         {/* 아래가 더 권장 배포시 !! */}
         <img src={process.env.PUBLIC_URL+"/assets/main.png"} alt="경로명으로 접근가능, public 폴더는 static 폴더이기 때문에 / 로 접근" />
         <h5>css파일에서 이미지 접근(background-image 속성)</h5>
